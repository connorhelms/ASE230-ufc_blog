...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $db->query(
            "UPDATE posts SET title = ?, content = ?, category = ?, image_url = ? 
             WHERE post_id = ?",
            [
                $_POST['title'],
                $_POST['content'],
...
<html>
<head>
    <title>Edit Post - Admin - UFC Blog</title>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <?php if ($post['image_url']): ?>
                    <div class="current-image">
                        <p>Current Image:</p>
                        <img src="<?= htmlspecialchars($post['image_url']) ?>" alt="Post" style="max-width: 200px">
                    </div>
                <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <p>Created: <?= date('F j, Y', strtotime($post['created_at'])) ?></p>
                </div>
